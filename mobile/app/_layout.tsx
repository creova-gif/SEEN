...
// rounded corners + Dynamic Island sit on top of the app surface. This frame
// is web-only — native builds (Expo Go / EAS / App Store / Play Store) render
// the app directly with no wrapper.
const PHONE_W = 390;
const PHONE_H = 844;
const BEZEL = 14;
const NOTCH_W = 120;
...
// initialMetrics so SafeAreaProvider reports a top inset on web (no real
// device insets exist) — screens then push content below the Dynamic Island.
...
export default function RootLayout() {
  ...
  // Native (Expo Go / EAS builds / App Store / Play Store) — render the app
  // directly, no bezel. The frame is purely a dev-preview affordance.
  if (Platform.OS !== 'web') {
    return (
  ...
  // canvas preview reads as a real device.
  return (
