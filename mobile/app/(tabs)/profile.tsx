...
const styles = StyleSheet.create({
  ...
  ctaText: { ...typography.cta, fontSize: 11, color: colors.textPrimary, letterSpacing: 2 },
  statsRow: {
    flexDirection: 'row',
    padding: spacing.lg,
  ...
  divider: { width: StyleSheet.hairlineWidth, backgroundColor: 'rgba(255,255,255,0.08)', marginHorizontal: spacing.sm },
