...
export function ReportContentScreen({ contentId, onBack }: ReportContentScreenProps) {
  ...
  const getText = (key: string) => {
    const translations: Record<string, Record<string, string>> = {
      ...
      reviewNote: {
        en: "This report is saved on your device. SEEN doesn't yet have a connected moderation service to receive and act on it.",
        fr: "Ce signalement est enregistré sur votre appareil. SEEN n'a pas encore de service de modération connecté pour le recevoir et y donner suite.",
        es: "Este reporte se guarda en tu dispositivo. SEEN aún no tiene un servicio de moderación conectado para recibirlo y actuar en consecuencia.",
      },
      submittedHeading: { en: "Report saved", fr: "Signalement enregistré", es: "Reporte guardado" },
      submittedBody: {
        en: "Thank you for flagging this. Your report is saved on this device — SEEN doesn't have a connected moderation service yet, so it isn't automatically sent anywhere.",
        fr: "Merci de l'avoir signalé. Votre signalement est enregistré sur cet appareil — SEEN n'a pas encore de service de modération connecté, il n'est donc envoyé nulle part automatiquement.",
        es: "Gracias por reportarlo. Tu reporte se guarda en este dispositivo — SEEN aún no tiene un servicio de moderación conectado, por lo que no se envía automáticamente a ningún lugar.",
      },
